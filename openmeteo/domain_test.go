...
// HTTP behaviour is covered in openmeteo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "openmeteo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("openmeteo", "about")
	if err != nil || got.String() != "openmeteo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want openmeteo://page/about", got.String(), err)
	}
}
