---
title: "openmeteo"
description: "A command line for openmeteo."
heroTitle: "openmeteo, from the command line"
heroLead: "A command line for openmeteo. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
openmeteo links <path>           # the pages it links to, each addressable
openmeteo serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading openmeteo by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address openmeteo as
  `openmeteo://` URIs and follow links across sites. See
