...
Most of these come down to network reality or how openmeteo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openmeteo rate-limits like any public site. openmeteo already paces
...
Where a surface is gated, openmeteo reads a cookie or token you supply
...
`openmeteo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openmeteo actually did
