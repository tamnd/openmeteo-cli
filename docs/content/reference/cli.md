...
```
openmeteo <command> [arguments] [flags]
```

Run `openmeteo <command> --help` for the full flag list on any command. This
...
per operation you declare in `openmeteo/domain.go`.
